...
<?php
 include ("connect.php");
  $input = $_POST["email"];
  $sql = "SELECT id, couts, email, whatsapp, prenom, pays, dates  FROM reg WHERE email = '$input'";
  ...
  if ($result->num_rows > 0) {
    ...
    <div>
    <?php
      printf("id: "."<b>".$row["id"]. "</b>" . "   -Couts: " . "<b>". $row["couts"]. "</b>". "   -email: " . "<b>". $row["email"]. "</b>". "   -whatsapp: " . "<b>". $row["whatsapp"]. "</b>". 
